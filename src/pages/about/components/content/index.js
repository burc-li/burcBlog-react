        ...
        return(
            <Fragment>
                ...
                <ContentWrapper>
                    ...
                    <ImformationBox>
                        <ImformationItem className="left">昵称<span>柏成</span></ImformationItem>
                        ...
                        <ImformationItem className="left">职业<span>前端开发工程师</span></ImformationItem>
                        <ImformationItem className="right">专业<span>软件工程</span></ImformationItem>
                        <ImformationItem className="left">现居地<span>北京市</span></ImformationItem>
                    </ImformationBox>
                    <Collapse defaultActiveKey={['2']}>
                        <Panel header="站点指南" key="1">
                            <p className="panelP">欢迎来到柏成✘の博客！</p>
                            ...
                            <p className="panelP">对了，柏成✘の博客可以完美适配手机、平板、PC端，so，你可以在pc端或者移动端打开对比一下有什么不同，其实也没什么太大差别。</p>
                        </Panel>
                        <Panel header="简单的自我介绍" key="2">
                            ...
                            <p className="panelP">柏成有一个炒鸡崇拜的大佬-花生PeA。作为学院最强Web开发的存在，花生PeA有着超级强大的能力以及貌似很高冷的性格。看完花生PeA的博客，我自闭了，so，经过学长的同意（借用了部分素材），柏成✘的博客正在孵化中...</p>
                ...
                <ContentWrapper className="phone">
                    ...
                    <Divider className="divider"></Divider>
                    <ImformationBox>
                        <ImformationItem className="phone">昵称<span>柏成</span></ImformationItem>
                        ...
                        <ImformationItem className="phone">职业<span>前端开发工程师</span></ImformationItem>
                        <ImformationItem className="phone">现居地<span>北京市</span></ImformationItem>
                    </ImformationBox>
